    ...
    methods:{
         init:function(){
            ...
            axios.get('/virtuelneMasine').then(response => {
                ...
                let maxRam =  Math.max.apply(Math,this.kategorijeRAMa);
...
<div class="container">
        ...
        <p v-if="virtuelneMasine.length==0">Trenutno nema nijedne virtuelne mašine.</p>
        <div v-else>
            <p>
            ...
            <table class="table">
                ...
                <tr v-for = "vm in virtuelneMasine" >
                    <td text-align="center">
                        <router-link class = "block-link" :to="{name:'detaljiVM', params:{vm:vm, tipKorisnika:tipKorisnika}}">
                            <p>{{vm.ime}}</p>
                        </router-link>
                    </td>
                    <td text-align="center">
